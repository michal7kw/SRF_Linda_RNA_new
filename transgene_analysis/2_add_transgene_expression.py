...
output_adata_path = f"counts_trans/merged_with_trans_gene.h5ad"
...
for sample in SAMPLES:
    transgene_adata_path = f"counts_trans/{sample}.h5ad"
...
if 'X_umap_alt' in adata_annotated_full.obsm and transgene_name in target_adata_final.var_names:
    try:
        ...
        print(f"Displaying UMAP plot for {transgene_name}...")
