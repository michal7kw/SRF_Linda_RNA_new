...
#
# Input:
#   - /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/celltype_results/DEG/{celltype}_{genotype}_DEGs.csv (from Step 3)
#   - /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/celltype_results/peak_gene_links/{celltype}_{genotype}_peak_gene_links.csv (from array jobs)
...
#
# Output:
#   - /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/DEG_coverage_plots_enhanced_separate/fragment_abundance/{celltype}_fragment_abundance_separate.pdf
#   - /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/DEG_coverage_plots_enhanced_separate/{celltype}_{genotype}/{gene}_coverage_separate.pdf
#   - /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/DEG_coverage_plots_enhanced_separate/peak_gene_links/{celltype}_{genotype}_{gene}_links.csv
################################################################################
...
cat("================================================================================\n")
cat("ENHANCED DEG COVERAGE PLOTS (Separate Genotypes - Using Pre-computed Links)\n")
cat("================================================================================\n\n")
...
if (length(all_links) == 0) {
  ...
  cat("\nYou must run peak-gene linkage array jobs first:\n")
  cat("  sbatch run_peak_gene_linkage_high_priority_L1.sh   # For GABA, Excitatory, Oligo, Immune\n")
  cat("  sbatch run_peak_gene_linkage_all_L1.sh             # For all L1 cell types\n\n")
