...
################################################################################
# Fix Fragment File Paths and Update Seurat Object - L2 Pipeline
################################################################################
#
# This script fixes fragment file paths for the L2 (fine-grained) cell type
...
echo "================================================================================"
echo "FIXING FRAGMENT FILE PATHS - L2 PIPELINE (Fine-grained Cell Types)"
echo "================================================================================"
echo ""
echo "Pipeline: signac_results/"
echo "Cell types: L2 (Astrocytes, CA1, CTX, Mature GC, ENT CTX, etc.)"
echo ""
echo "================================================================================"
echo ""
...
INPUT_DIR="$BASE_DIR/signac_results/translated_fragments"
OUTPUT_DIR="$BASE_DIR/signac_results/fragments_with_prefix"
...
FIX_SCRIPT="$BASE_DIR/scripts/Legacy/fix_fragment_links.R"
if [ ! -f "$FIX_SCRIPT" ]; then
    echo "ERROR: Fragment fix script not found: $FIX_SCRIPT"
    exit 1
fi

echo "Running fragment link fix script..."
echo ""
...
BACKUP_FILE="$BASE_DIR/signac_results/integrated_seurat_processed_backup_before_fragment_fix.rds"
...
SEURAT_FILE="$BASE_DIR/signac_results/integrated_seurat_processed.rds"
...
echo "Next Steps:"
echo ""
echo "1. Test coverage plots:"
echo "   sbatch run_viz2_deg_coverage_enhanced.sh"
echo ""
echo "2. Run other visualization scripts:"
