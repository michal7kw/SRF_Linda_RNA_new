#!/bin/bash
#SBATCH --job-name=plot_cell_type_L2_new_markers_all_methods
#SBATCH --output=./logs/plot_cell_type_L2_new_markers_all_methods_%a.out
#SBATCH --error=./logs/plot_cell_type_L2_new_markers_all_methods_%a.err
#SBATCH --array=0-3
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Master script to generate all visualization types for cell type L2 markers
...
SCRIPTS=(
    "${SCRIPT_DIR}/plot_cell_type_L2_new_markers_dotplot.py"
    "${SCRIPT_DIR}/plot_cell_type_L2_new_markers_matrixplot.py"
    # "${SCRIPT_DIR}/plot_cell_type_L2_new_markers_stacked_violin.py"
    "${SCRIPT_DIR}/plot_cell_type_L2_new_markers_heatmap.py"
)
...
echo "========================================================================"
echo "CELL TYPE L2 MARKER VISUALIZATION - ${NAME}"
