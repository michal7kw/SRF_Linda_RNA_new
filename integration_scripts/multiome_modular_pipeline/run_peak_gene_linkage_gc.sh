...
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --output=logs/run_peak_gene_linkage_gc.out
#SBATCH --error=logs/run_peak_gene_linkage_gc.err

################################################################################
# SLURM Job Script: Peak-Gene Linkage Analysis for Granule Cells
#
# This script computes peak-gene correlations for genes in genes_gc.txt.
# Visualization step has been separated into run_visualization_gc.sh.
#
...
#
# Usage:
#   sbatch run_peak_gene_linkage_gc.sh        # Linkage analysis only
#   sbatch run_visualization_gc.sh            # Visualization (after linkage)
################################################################################
...
echo "================================================================================"
echo "PEAK-GENE LINKAGE ANALYSIS: GRANULE CELLS"
echo "================================================================================"
...
RESULTS_DIR="signac_results_L1/peak_gene_linkage_analysis/GC"
...
echo ""
echo "Next steps:"
echo "  - To create visualizations, run: sbatch run_visualization_gc.sh"
echo "================================================================================"
