...
################################################################################
# Signac Multiome Analysis - Step 6: Create BigWig Tracks for IGV
################################################################################
#
...
#
# Features:
#   - Pseudobulk aggregation by cell type and condition
...
#
# Output:
#   - BigWig files organized by cell type and condition
...
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/bigwig_tracks/by_sample/{Genotype}-{Condition}_all_cells.bw
#   - Per-celltype BigWig tracks:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/bigwig_tracks/by_celltype/{CellType}_{Genotype}-{Condition}.bw
#   - IGV session file:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/bigwig_tracks/igv_session.xml
#   - README with usage instructions:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/bigwig_tracks/README.md
#
################################################################################
...
cat("================================================================================\n")
cat("  SIGNAC MULTIOME ANALYSIS - STEP 6: CREATE BIGWIG TRACKS FOR IGV\n")
cat("================================================================================\n\n")
...
TRANSLATED_FRAG_DIR <- file.path(INPUT_DIR, "translated_fragments")
OUTPUT_DIR <- file.path(INPUT_DIR, "bigwig_tracks")
