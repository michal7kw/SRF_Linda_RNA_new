...
################################################################################
# Signac Multiome Analysis - Step 1: Data Loading and Integration (L1 VERSION)
################################################################################
#
# This script loads scRNA-seq and scATAC-seq data and creates an integrated
# Seurat object following Signac best practices.
#
# L1 VERSION: Uses cell_type_L1 annotations (9 broad categories)
# Outputs to: signac_results_L1/
#
# Inputs:
#   - ATAC: chromap peak-barcode matrices and fragment files
#     * Matrix files: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_ATAC_data/chromap_final_output/{sample}_filtered_peak_bc_matrix_pseudobulk/
#       - matrix.mtx.gz (peak-barcode matrix)
#       - barcodes.tsv.gz (cell barcodes)
#       - features.tsv.gz (peak coordinates)
#     * Fragment files: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_ATAC_data/chromap_final_output/fragments/{sample}_fragments.tsv.gz
#     * Samples: R26-Nestin-Ctrl-adult, R26-Nestin-Mut-adult, R26-Emx1-Ctrl-adult, R26-Emx1-Mut-adult
#   - RNA: h5ad file (converted to Seurat) with cell type annotations
#     * File: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/combine_data/results_from_raw/annotation_final.h5ad
#   - Barcode translation files:
#     * RNA whitelist: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/DATA/Data_integration/arc_barcode_lists/gex_737K-arc-v1.txt
#     * ATAC whitelist: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_ATAC_data/barcode_whitelists/atac_737K-arc-v1_rc.txt
#
# Outputs:
#   - Integrated Seurat object with both RNA and ATAC assays
#     * Primary output: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/integrated_seurat_raw.rds
#   - QC plots and metrics
#     * QC overview: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/qc/01_atac_qc_overview.pdf
#   - Summary statistics
#     * Integration summary: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/integration_summary.csv
#   - Translated fragment files (if bgzip/tabix available)
#     * Directory: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/translated_fragments/
#     * Files: {sample}_fragments_translated.tsv.gz for each sample
#   - Cache files (for faster reruns)
#     * Integrated object cache: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/cache/integrated_seurat_object.rds
#     * Consensus peaks cache: /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1/cache/consensus_peaks.rds
#
#
################################################################################
...
OUTPUT_DIR <- file.path(BASE_DIR, "SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results_L1")
