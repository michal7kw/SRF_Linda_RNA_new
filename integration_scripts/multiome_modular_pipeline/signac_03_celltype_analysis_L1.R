...
################################################################################
# Signac Multiome Analysis - Step 3: Cell-Type-Specific Differential Analysis (L1 VERSION)
################################################################################
#
# This script performs comprehensive cell-type-specific analysis at L1 level:
#   1. Differential gene expression (RNA) - Ctrl vs Mut per L1 cell type
#   2. Differential accessibility (ATAC) - Ctrl vs Mut per L1 cell type
#   3. Peak-gene linkage using Signac's LinkPeaks with correlation
#   4. Integration with existing DEG results
#
# L1 VERSION: Analyzes 9 broad cell categories (Excitatory, GABA, Oligo, etc.)
# Outputs to: signac_results_L1/celltype_results/
#
# INPUTS:
...
#   - Cell-type-specific analysis at L1 level
...
# Analysis parameters
CELLTYPE_COL <- "cell_type_L1"      # Cell type annotation column (L1: 9 broad categories)
