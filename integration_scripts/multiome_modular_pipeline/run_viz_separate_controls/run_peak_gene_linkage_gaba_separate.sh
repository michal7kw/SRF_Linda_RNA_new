#!/bin/bash
#SBATCH --job-name=linkage_gaba_sep
...
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --output=logs/linkage_gaba_separate.out
#SBATCH --error=logs/linkage_gaba_separate.err

################################################################################
# SLURM Job Script: Peak-Gene Linkage Analysis for GABA Neurons (Separate Genotypes)
#
# This script runs the complete peak-gene linkage workflow for GABA neurons
# with separate analysis for each genotype (no combined controls):
# 1. Computes peak-gene correlations for genes in genes_inter.txt
...
#
# Usage:
#   sbatch run_peak_gene_linkage_gaba_separate.sh
################################################################################
...
echo "================================================================================"
echo "PEAK-GENE LINKAGE ANALYSIS: GABA NEURONS (SEPARATE GENOTYPES)"
echo "================================================================================"
...
Rscript ./scripts/analyze_peak_gene_linkage_gaba_separate_UPDATED.R
...
Rscript visualize_peak_gene_linkage_gaba_separate.R
...
RESULTS_DIR="signac_results_L1/peak_gene_linkage_analysis_separate/GABA"
