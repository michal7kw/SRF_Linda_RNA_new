...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=logs/run_viz2_deg_coverage_enhanced_separate.out
#SBATCH --error=logs/run_viz2_deg_coverage_enhanced_separate.err
...
Rscript scripts/separate_version/create_coverage_plots_from_DEGs_enhanced_separate.R
