...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=logs/run_viz2_deg_coverage_enhanced.out
#SBATCH --error=logs/run_viz2_deg_coverage_enhanced.err
...
Rscript scripts/create_coverage_plots_from_DEGs_enhanced.R
