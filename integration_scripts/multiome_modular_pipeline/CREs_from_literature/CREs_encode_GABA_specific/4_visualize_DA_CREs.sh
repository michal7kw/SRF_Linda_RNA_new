...
#
# Prerequisites:
# - output/heatmaps_deeptools/matrix_*.gz
...
#   SKIP_INDIVIDUAL=1 sbatch 4_visualize_DA_CREs.sh  # Fast mode
#   MIN_SIGNAL=2.0 MIN_FC=2.0 sbatch 4_visualize_DA_CREs.sh  # Stricter
################################################################################

echo "========================================================================"
echo "VISUALIZE DIFFERENTIALLY ACCESSIBLE GABA-SPECIFIC CREs"
echo "========================================================================"
echo "Started: $(date)"
echo ""
