...
def plot_combined_overview(data, bin_labels, output_file, title, n_cres):
    ...
    # Only plot 3 conditions (Emx1-Ctrl excluded - failed sample)
...
Examples:
  ...
  python %(prog)s --parallel 8 --individual-dpi 300
    ...
    parser.add_argument('--matrix', type=str, default='all_celltypes',
                       help='Matrix to use: all_celltypes or CRE type name (default: all_celltypes)')
