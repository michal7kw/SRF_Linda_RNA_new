...
tsv_all = os.path.join(OUTPUT_DIR, "encode_cCREs_all_celltypes.tsv")
...
# =============================================================================
# Step 2: Convert GABA Cell Types
# =============================================================================

print("\n" + "="*80)
print("STEP 2: Converting GABA cell types")
print("-"*80)

tsv_gaba = os.path.join(OUTPUT_DIR, "encode_cCREs_GABA.tsv")
bed_gaba = os.path.join(OUTPUT_DIR, "encode_cCREs_GABA.bed")

if os.path.exists(tsv_gaba):
    df_gaba = pd.read_csv(tsv_gaba, sep='\t')
    print(f"Loaded {len(df_gaba):,} CRE-gene links")
    bed_gaba_df = convert_tsv_to_bed(df_gaba, bed_gaba, "GABA cell types")
else:
