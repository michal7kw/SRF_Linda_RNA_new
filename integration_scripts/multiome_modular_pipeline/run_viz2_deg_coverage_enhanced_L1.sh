...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=logs/run_viz2_deg_coverage_enhanced_L1.out
#SBATCH --error=logs/run_viz2_deg_coverage_enhanced_L1.err

################################################################################
# SLURM Job Script: Enhanced Coverage Plots for DEGs (Combined Controls)
#
# This script creates comprehensive visualizations including:
#   - Per-cell fragment abundance plots by cell type
#   - Coverage plots with ATAC + RNA
#   - Peak-gene linkage computation
...
#
# Usage:
#   sbatch run_deg_coverage_enhanced.sh
################################################################################
...
echo "================================================================================"
echo "ENHANCED DEG COVERAGE PLOTS (COMBINED CONTROLS)"
echo "================================================================================"
...
RESULTS_DIR="signac_results_L1/DEG_coverage_plots_enhanced"
