#!/usr/bin/env python3
"""
Script to generate marker gene expression heatmaps for cell_type_L1 annotations
...
OUTPUT_DIR = '/beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/ADDITIONAL_PLOTS/heatmaps/L1'
...
def create_heatmap(adata, marker_genes_dict, output_dir, top_n_genes, max_cells_per_type=200,
    ...
    fig_width = max(12, n_genes * 0.40)
    fig_height = max(14, min(n_cells * 0.04, 45))  # Cap height
    fontsize = 12
...
def main():
    ...
    print("="*80)
    print("CELL TYPE L1 MARKER GENE HEATMAP GENERATION")
    print("="*80)
