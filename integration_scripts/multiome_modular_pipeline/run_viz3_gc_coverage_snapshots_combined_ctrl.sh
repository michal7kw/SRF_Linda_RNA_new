...
#SBATCH --job-name=viz3_gc
#SBATCH --output=logs/run_viz3_gc_coverage_snapshots_combined_ctrl.out
#SBATCH --error=logs/run_viz3_gc_coverage_snapshots_combined_ctrl.err
#SBATCH --ntasks=1
...
Rscript ${BASE_DIR}/scripts/create_gc_coverage_snapshots_combined_ctrl.R 2>&1
...
echo "End time: $(date)"
echo ""
echo "Results saved to: ${BASE_DIR}/signac_results/plots/gc_coverage_snapshots_combined_ctrl/"
echo ""
echo "Output files:"
