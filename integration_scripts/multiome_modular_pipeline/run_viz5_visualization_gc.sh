...
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=logs/run_viz5_visualization_gc.out
#SBATCH --error=logs/run_viz5_visualization_gc.err

################################################################################
# SLURM Job Script: Peak-Gene Linkage Visualization for Granule Cells
#
...
#
# Prerequisites:
#   - Must run analyze_peak_gene_linkage_gc_UPDATED.R first --> run_peak_gene_linkage_gc.sh
#   - Requires existing linkage CSV files in signac_results_L1/peak_gene_linkage_analysis/GC/
#
...
#
# Usage:
#   sbatch run_visualization_gc.sh
################################################################################
...
echo "================================================================================"
echo "PEAK-GENE LINKAGE VISUALIZATION: GRANULE CELLS"
echo "================================================================================"
...
Rscript scripts/visualize_peak_gene_linkage_gc.R
...
RESULTS_DIR="signac_results/peak_gene_linkage_analysis/GC"
