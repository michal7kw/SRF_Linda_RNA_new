...
################################################################################
# POST-PROCESSING FILTERS FOR MULTIOME RESULTS
################################################################################
#
...
#
# Usage:
#   Rscript POST_PROCESSING_FILTERS.R
#
# Output:
#   - Creates filtered/ subdirectory with high-confidence results
...
# Outputs:
#   - Filtered DA results:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/celltype_results/filtered/{celltype}_{genotype}_DA_peaks.csv
#   - Filtered peak-gene links:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/celltype_results/filtered/{celltype}_{genotype}_peak_gene_links.csv
#   - DA filtering summary:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/celltype_results/filtered/DA_filtering_summary.csv
#   - Links filtering summary:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/celltype_results/filtered/links_filtering_summary.csv
#   - DA filtering comparison plots:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/celltype_results/filtered/DA_filtering_comparison.pdf
#   - Correlation distribution plots:
#     /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Linda_RNA/integration_scripts/multiome_modular_pipeline/signac_results/celltype_results/filtered/correlation_distribution.pdf
#
################################################################################
...
# Configuration
BASE_DIR <- "signac_results/celltype_results"
OUTPUT_DIR <- "signac_results/celltype_results/filtered"
