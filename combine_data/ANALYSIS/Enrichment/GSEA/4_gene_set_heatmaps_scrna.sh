#!/bin/bash
#SBATCH --job-name=gene_set_heatmaps_scrna
#SBATCH --output=logs/gene_set_heatmaps_scrna.out
#SBATCH --error=logs/gene_set_heatmaps_scrna.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python gene_set_heatmaps_scrna.py